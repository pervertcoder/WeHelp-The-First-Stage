...
![img](https://github.com/pervertcoder/WeHelp-The-First-Stage/blob/main/week_five/截圖/TASK_5_REQUEST_1.png)
...
![img](https://github.com/pervertcoder/WeHelp-The-First-Stage/blob/main/week_five/截圖/TASK_5_REQUEST_2.png)
...
![img](https://github.com/pervertcoder/WeHelp-The-First-Stage/blob/main/week_five/截圖/TASK_5_REQUEST_3.png)

REQUEST4:  
select avg(like_count)as like_count_test  
from message  
join member on message.member_id = member.id  
where member.email = 'test@test.com';

![img](https://github.com/pervertcoder/WeHelp-The-First-Stage/blob/main/week_five/截圖/TASK_5_REQUEST_4.png)
